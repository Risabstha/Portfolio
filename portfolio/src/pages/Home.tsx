...
import dot from "../assets/singledot.png";
const Home = () => {
  return (
    <div className="flex md:ml-[6rem] px-4 ">
      <p>
        I’m Risab, a creative web developer who loves building clean,
      ...
      <div className="relative w-[20rem]">
        ...
        <img className="relative" src={profile} alt="profile" />
        <div className={`w-80 h-80 bg-black bg-[url(${dot})] bg-repeat bg-[length:20px_20px]`}></div>
      </div>
    </div>
  );
};
