  ...
  return (
    <div >
      ...
      <div className="hidden md:flex md:justify-center md:ml-[1.5rem] lg:ml-[1.5rem] xl:ml-[2rem]">
        <div className="flex  xl:w-[80vw] lg:w-[85vw] md:w-[88vw]  md:gap-[2rem] lg:gap-[4rem]  xl:gap-[6rem] pt-[5rem] px-4 ">
          <div className="w-[60vw] pt-12   space-y-4">
            ...
            <p className="md:text-xl lg:text-2xl xl:text-3xl font-semibold ">
              I am a{" "}
              <span className="text-[#C778DD]  pr-1 ">
                {state.displayed}
          ...
          <div className="relative  w-[40vw] flex justify-center">
            <svg
              className="absolute xl:top-15 xl:left-5"
              width="120"
              height="120"
              viewBox="-1 -1 158 158"
              fill="none"
            ...
            <div
              className={`grid grid-cols-5 gap-1 w-22 h-22 absolute xl:top-50 xl:right-20 md:opacity-60`}
            >
      ...
      <div className="md:hidden flex justify-center">
        <div className=" w-[100vw] pt-[5rem] px-4 ">
          {/* <div className="flex justify-center  z-0"> */}
            <div className="relative z-[0]  m-auto w-[60vw] flex justify-center">
              <svg
